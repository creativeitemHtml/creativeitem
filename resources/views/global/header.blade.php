<!-- Start Small Header -->
<section class="top-social-header-section">
    <div class="container-xxl">
        <div class="row">
            <div class="col-12">
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 top-social-header">
                    <a href="#" class="d-flex align-items-center gap-1 white-icontext-link1">
                        <img src="{{ asset('assets/img/home-2/call-white-20.svg') }}" alt="icon">
                        <span>support.creativeitem.com</span>
                    </a>
                    <ul class="d-flex align-items-center g-12px flex-wrap">
                        <li>
                            <a href="#" class="sm-white-svg-icon">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M18.3307 13.4916C18.3307 16.525 16.5224 18.3333 13.4891 18.3333H12.4974C12.0391 18.3333 11.6641 17.9583 11.6641 17.5V12.6916C11.6641 12.4666 11.8474 12.275 12.0724 12.275L13.5391 12.25C13.6557 12.2416 13.7557 12.1583 13.7807 12.0416L14.0724 10.45C14.0974 10.3 13.9807 10.1583 13.8224 10.1583L12.0474 10.1833C11.8141 10.1833 11.6307 9.99997 11.6224 9.77497L11.5891 7.73329C11.5891 7.59996 11.6974 7.4833 11.8391 7.4833L13.8391 7.44996C13.9807 7.44996 14.0891 7.34164 14.0891 7.19997L14.0557 5.19995C14.0557 5.05828 13.9474 4.94996 13.8057 4.94996L11.5557 4.9833C10.1724 5.0083 9.07241 6.14162 9.09741 7.52496L9.13906 9.81662C9.1474 10.05 8.96407 10.2333 8.73074 10.2416L7.73073 10.2583C7.58906 10.2583 7.48074 10.3666 7.48074 10.5083L7.50574 12.0916C7.50574 12.2333 7.61406 12.3416 7.75573 12.3416L8.75574 12.325C8.98907 12.325 9.17239 12.5083 9.18072 12.7333L9.25572 17.4833C9.26405 17.95 8.88905 18.3333 8.42238 18.3333H6.50573C3.47239 18.3333 1.66406 16.525 1.66406 13.4833V6.50829C1.66406 3.47496 3.47239 1.66663 6.50573 1.66663H13.4891C16.5224 1.66663 18.3307 3.47496 18.3307 6.50829V13.4916Z" fill="white"/>
                                </svg>                    
                            </a>
                        </li>
                        <li>
                            <a href="#" class="sm-white-svg-icon">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M1.67188 2.86397C1.67188 2.20446 2.2199 1.66998 2.89608 1.66998H17.1177C17.7938 1.66998 18.3419 2.20446 18.3419 2.86397V17.146C18.3419 17.8055 17.7938 18.34 17.1177 18.34H2.89608C2.2199 18.34 1.67188 17.8055 1.67188 17.146V2.86397ZM6.82186 15.6249V8.09731H4.32032V15.6249H6.82186ZM5.57161 7.06898C6.44366 7.06898 6.98648 6.49178 6.98648 5.76872C6.97085 5.03003 6.4447 4.46846 5.58828 4.46846C4.73186 4.46846 4.17238 5.03107 4.17238 5.76872C4.17238 6.49178 4.71519 7.06898 5.55494 7.06898H5.57161ZM10.6851 15.6249V11.4209C10.6851 11.1958 10.7018 10.9708 10.7685 10.8104C10.9487 10.3613 11.3603 9.89559 12.0521 9.89559C12.9575 9.89559 13.319 10.5853 13.319 11.598V15.6249H15.8205V11.3073C15.8205 8.99436 14.587 7.91915 12.9408 7.91915C11.6134 7.91915 11.0185 8.64846 10.6851 9.16211V9.18815H10.6685L10.6851 9.16211V8.09731H8.18464C8.21589 8.8037 8.18464 15.6249 8.18464 15.6249H10.6851Z" fill="white"/>
                                </svg>                                        
                            </a>
                        </li> 
                        <li>
                            <a href="#" class="sm-white-svg-icon">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M18.3114 9.50835C18.028 4.67502 13.6364 0.950029 8.57804 1.78336C5.0947 2.35836 2.30304 5.18335 1.76138 8.66668C1.44471 10.6833 1.86139 12.5917 2.76973 14.1667L2.02805 16.925C1.86138 17.55 2.43637 18.1167 3.05303 17.9417L5.76971 17.1917C7.00304 17.9167 8.44471 18.3333 9.98637 18.3333C14.6864 18.3333 18.5864 14.1917 18.3114 9.50835ZM14.0614 13.1C13.9864 13.25 13.8947 13.3917 13.778 13.525C13.5697 13.75 13.3447 13.9167 13.0947 14.0167C12.8447 14.125 12.5697 14.175 12.278 14.175C11.853 14.175 11.3947 14.075 10.9197 13.8667C10.4364 13.6584 9.96139 13.3833 9.48639 13.0417C9.00306 12.6917 8.55305 12.3 8.11971 11.875C7.68638 11.4417 7.30303 10.9833 6.95303 10.5083C6.61136 10.0333 6.33638 9.55835 6.13638 9.08335C5.93638 8.60835 5.83639 8.15002 5.83639 7.71669C5.83639 7.43336 5.88638 7.15836 5.98638 6.90836C6.08638 6.65002 6.24473 6.41669 6.46973 6.20836C6.7364 5.94169 7.02805 5.81669 7.33638 5.81669C7.45305 5.81669 7.56969 5.84169 7.67802 5.89169C7.78636 5.94169 7.88638 6.01669 7.96138 6.12502L8.92802 7.49168C9.00302 7.60001 9.06137 7.69168 9.0947 7.78335C9.13637 7.87501 9.15304 7.95834 9.15304 8.04168C9.15304 8.14168 9.11972 8.24169 9.06138 8.34169C9.00305 8.44169 8.92803 8.54168 8.82803 8.64168L8.51136 8.97501C8.46136 9.02501 8.44473 9.07502 8.44473 9.14169C8.44473 9.17502 8.45302 9.20835 8.46136 9.24168C8.47802 9.27501 8.48639 9.30002 8.49472 9.32502C8.56972 9.46669 8.70303 9.64167 8.88637 9.85834C9.07803 10.075 9.27807 10.3 9.49473 10.5167C9.71973 10.7417 9.93639 10.9417 10.1614 11.1333C10.3781 11.3167 10.5614 11.4417 10.703 11.5167C10.728 11.525 10.753 11.5417 10.778 11.55C10.8114 11.5667 10.8447 11.5667 10.8864 11.5667C10.9614 11.5667 11.0114 11.5417 11.0614 11.4917L11.378 11.175C11.4864 11.0667 11.5864 10.9917 11.6781 10.9417C11.7781 10.8834 11.8697 10.85 11.9781 10.85C12.0614 10.85 12.1447 10.8667 12.2364 10.9083C12.328 10.95 12.428 11 12.528 11.075L13.9114 12.0584C14.0197 12.1334 14.0947 12.225 14.1447 12.325C14.1864 12.4334 14.2114 12.5333 14.2114 12.65C14.1614 12.7917 14.1281 12.95 14.0614 13.1Z" fill="white"/>
                                </svg>                                                            
                            </a>
                        </li>
                        <li>
                            <a href="#" class="sm-white-svg-icon">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M14.1641 3.33337H5.83073C3.33073 3.33337 1.66406 5.00004 1.66406 7.50004V12.5C1.66406 15 3.33073 16.6667 5.83073 16.6667H14.1641C16.6641 16.6667 18.3307 15 18.3307 12.5V7.50004C18.3307 5.00004 16.6641 3.33337 14.1641 3.33337ZM11.5724 10.8584L9.51405 12.0917C8.68071 12.5917 7.99738 12.2084 7.99738 11.2334V8.75838C7.99738 7.78338 8.68071 7.40005 9.51405 7.90005L11.5724 9.13337C12.3641 9.6167 12.3641 10.3834 11.5724 10.8584Z" fill="white"/>
                                </svg>                                                                              
                            </a>
                        </li>
                    </ul>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mega-menu-items">
                                                    <a href="{{ route('web_applications') }}" class="mega-menu-item mega-menu-item-1">
                                                        <div class="icon">
                                                            <img
                                                            src="{{ asset('assets/img/new-icons-images/mega-1.svg') }}"
                                                            alt=""
                                                            />
                                                        </div>
                                                        <div class="content">
                                                    ...
                                                    <a href="{{ route('lms.home') }}" class="mega-menu-item mega-menu-item-2">
                                                        <div class="icon">
                                                            <img
                                                            src="{{ asset('assets/img/new-icons-images/mega-4.svg') }}"
                                                            alt=""
                                                            />
                                                        </div>
                                                        <div class="content">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mega-menu-items">
                                                    <a href="{{ route('elements') }}" class="mega-menu-item mega-menu-item-3">
                                                        <div class="icon">
                                                            <img
                                                            src="{{ asset('assets/img/new-icons-images/mega-2.svg') }}"
                                                            alt=""
                                                            />
                                                        </div>
                                                        <div class="content">
                                        ...
                                        <ul class="mobile-dropdown mobile-dropdown-mega">
                                            <a href="{{ route('web_applications') }}">
                                                <div class="mobile-mega-single">
                                                    ...
                                                    <h4 class="mega-heading">{{ get_phrase('Web Applications') }}</h4>
