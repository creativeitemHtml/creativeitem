        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2 col-md-10 offset-md-1">
                <div class="text-center mt-5 mb-40px">
                    <h1 class="es-title-1 mb-3">The Best Way To Build Your Online Education System with <span class="text-red-gradient3">Academy LMS</span></h1>
                    <p class="man-subtitle-1 mb-40px">Lorem Ipsum available, but the majority have  suffered alteration in some form.</p>
                    <div class="d-flex align-items-center g-30px flex-wrap justify-content-center">
                        ...
                        <a href="#" class="btn btn-underline-ci1">Watch Video</a>
                    </div>
                </div>
            </div>
        </div>
...
<section>
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h1 class="es-title-1 text-center max-w-575px mx-auto mb-32px">Deliver Great e-learning <span class="text-red-gradient3">Experiences</span></h1>
            </div>
        </div>
        <div class="row mb-100px justify-content-center">
            <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="max-w-255px mx-auto">
                    ...
                    <h4 class="man-title-3 mb-4 text-center">Online Coaching Platform</h4>
                    <p class="man-subtitle-2 text-center">Build the best WordPress platform for your online coaching business.</p>
                </div>
            </div>
            <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="max-w-255px mx-auto">
                    ...
                    <h4 class="man-title-3 mb-4 text-center">School Learning Management System</h4>
                    <p class="man-subtitle-2 text-center">Build the best WordPress platform for your online coaching business.</p>
                </div>
            </div>
            <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="max-w-255px mx-auto">
                    ...
                    <h4 class="man-title-3 mb-4 text-center">Corporate Training LMS</h4>
                    <p class="man-subtitle-2 text-center">Build the best WordPress platform for your online coaching business.</p>
                </div>
            </div>
            <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="max-w-255px mx-auto">
                    ...
                    <h4 class="man-title-3 mb-4 text-center">eLearning  Marketplace</h4>
                    <p class="man-subtitle-2 text-center">Build the best WordPress platform for your online coaching business.</p>
                </div>
            </div>
        </div>
        ...
        <div class="row mb-100px">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="number-info-card max-md-w-450px mx-auto" style="--bg-color: linear-gradient(226deg, #fc37ec 7.61%, #3530ff 50.44%, #ffe590 87.9%);">
                            <h1 class="wh-esans-title-2 mb-12px">50,000+</h1>
                            <p class="wh-man-subtitle-1">Active Online Users</p>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="number-info-card max-md-w-450px mx-auto" style="--bg-color: linear-gradient(221deg, #ff0100 22.03%, #ff9300 51.02%, #e3bfdb 69.3%);">
                            <h1 class="wh-esans-title-2 mb-12px">60%</h1>
                            <p class="wh-man-subtitle-1">Less Cost From Other LMS Software</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="number-info-card number-info-card2  max-md-w-450px mx-auto h-100" style="--bg-color: linear-gradient(134deg, #6e3bff 19.23%, #ef15a8 69.26%, #ffc0c6 100%);">
                    <h1 class="wh-esans-title-1 mb-4">100%</h1>
                    ...
                    <p class="wh-man-subtitle-2 mb-3">Customer Satisfaction</p>
                    <p class="wh-man-subtitle-3">Delivering exceptional results with over 100% customer satisfaction</p>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-6 col-sm-12">
                        <div class="number-info-card max-md-w-450px mx-auto" style="--bg-color: linear-gradient(135deg, #ffe920 2.28%, #22cdfd 60.34%, #8d41c7 100%);">
                            <h1 class="wh-esans-title-2 mb-12px">30,000+</h1>
                            <p class="wh-man-subtitle-1">Total Downloads</p>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-6 col-sm-12">
                        <div class="number-info-card max-md-w-450px mx-auto" style="--bg-color: linear-gradient(136deg, #60f2ff 0%, #b733fb 46.04%, #6b38ff 96.77%);">
                            <h1 class="wh-esans-title-2 mb-12px">24/7</h1>
                            <p class="wh-man-subtitle-1">Customer Support</p>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="online-course-section mb-100px">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-md-6">
                <div>
                    <h1 class="es-title-1 es-title-1-black mb-30px">Unleash Your Self Learning</h1>
                    <!-- Accordion -->
...
<section>
    <div class="container">
        <div class="row align-items-center mb-100px">
            <!-- right -->
            <div class="col-lg-4 col-md-12">
                <h1 class="es-title-1 es-title-1-black mb-4">Service we will can help you with</h1>
                <p class="man-subtitle-2 man-subtitle-2-black">We’ve made it easier than ever to create, manage, and grow a profitable coaching business that achieves transformational client results. Lorem Ipsum available, but the majority have suffered.</p>
            </div>
            <!-- grid -->
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="lg-mt-80px">
                            <div class="gradient-card-1 mb-30px max-md-w-450px mx-auto" style="--bg-color: linear-gradient(221deg, #ff0100 18.99%, #ff9300 43.32%, #e3bfdb 66.8%);">
                                ...
                                <h4 class="mb-20px man-title-4 text-white">Website Design</h4>
                                <p class="wh-man-subtitle-1">Delivering exceptional results with over 100% customer satisfaction. Delivering  customer satisfaction.</p>
                            </div>
                            <div class="gradient-card-1 max-md-w-450px mx-auto" style="--bg-color: linear-gradient(216deg, #fc37ec 18.36%, #3531ff 54.67%, #ffe590 90.83%);">
                                ...
                                <h4 class="mb-20px man-title-4 text-white">Web Development</h4>
                                <p class="wh-man-subtitle-1">Delivering exceptional results with over 100% customer satisfaction. Delivering  customer satisfaction.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="gradient-card-1 mb-30px max-md-w-450px mx-auto" style="--bg-color: linear-gradient(135deg, #6e3bff 19.23%, #ef15a8 69.26%, #ffc0c6 92.65%);">
                            ...
                            <h4 class="mb-20px man-title-4 text-white">Web Applications</h4>
                            <p class="wh-man-subtitle-1">Delivering exceptional results with over 100% customer satisfaction. Delivering  customer satisfaction.</p>
                        </div>
                        <div class="gradient-card-1 max-md-w-450px mx-auto" style="--bg-color: linear-gradient(140deg, #ffe920 9.82%, #22cdfd 40.55%, #8d41c7 100%);">
                            ...
                            <h4 class="mb-20px man-title-4 text-white">Content Writing</h4>
                            <p class="wh-man-subtitle-1">Delivering exceptional results with over 100% customer satisfaction. Delivering  customer satisfaction.</p>
                        </div>
                    </div>
                </div>
...
<section>
    <div class="container">
        <div class="row mb-100px align-items-center">
            ...
            <div class="col-md-7">
                <h1 class="es-title-1 es-title-1-black mb-32px">The Leading Online Course Builder</h1>
                <div class="mb-32px">
                    <ul class="nav nav-pills nav-pills-underline mb-20px" id="pills-tab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="pills-item1-tab" data-bs-toggle="pill" data-bs-target="#pills-item1" type="button" role="tab" aria-controls="pills-item1" aria-selected="true">Course Website</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-item2-tab" data-bs-toggle="pill" data-bs-target="#pills-item2" type="button" role="tab" aria-controls="pills-item2" aria-selected="false">Lessons</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-item3-tab" data-bs-toggle="pill" data-bs-target="#pills-item3" type="button" role="tab" aria-controls="pills-item3" aria-selected="false">Quizzes</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-item4-tab" data-bs-toggle="pill" data-bs-target="#pills-item4" type="button" role="tab" aria-controls="pills-item4" aria-selected="false">Quizzes</button>
                        </li>
                    </ul>
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-item1" role="tabpanel" aria-labelledby="pills-item1-tab">
                            <p class="man-subtitle-2 man-subtitle-2-black">We’ve made it easier than ever to create, manage, and grow a profitable coaching business that achieves transformational client results. Lorem Ipsum available, but the majority have suffered. We’ve made it easier than ever to create, manage, and grow a profitable coaching business.</p>
                        </div>
                ...
                <a href="#" class="btn btn-primary-ci1">Watch Demo</a>
            </div>
        </div>
    </div>
</section>
...
<section>
    <div class="container">
        <div class="row mb-100px align-items-center overflow-hidden">
            ...
            <div class="col-md-6">
                <h1 class="es-title-1 es-title-1-black mb-4">The  Online Player Integration</h1>
                <p class="man-subtitle-2 man-subtitle-2-black mb-32px">We’ve made it easier than ever to create, manage, and grow a profitable coaching business that client results.</p>
...
<section>
    <div class="container">
        <div class="row align-items-center mb-100px">
            <div class="col-md-6">
                <h1 class="es-title-1 es-title-1-black mb-4">Communicate with students</h1>
                <p class="man-subtitle-2 man-subtitle-2-black mb-32px">We’ve made it easier than ever to create, manage, and grow a profitable coaching business that client results.</p>
                <ul class="d-flex flex-column g-30px">
                    <li class="d-flex gap-3">
                        ...
                        <div>
                            <h4 class="man-subtitle-3 mb-12px">Questions and Answers</h4>
                            <p class="man-subtitle-2 man-subtitle-2-black">We’ve made it easier than ever to create, manage, and grow a profitable coaching business that client results.</p>
                        </div>
                    </li>
                    <li class="d-flex gap-3">
                        ...
                        <div>
                            <h4 class="man-subtitle-3 mb-12px">Course FAQ</h4>
                            <p class="man-subtitle-2 man-subtitle-2-black">We’ve made it easier than ever to create, manage, and grow a profitable coaching business that client results.</p>
                        </div>
                    </li>
                    <li class="d-flex gap-3">
                        ...
                        <div>
                            <h4 class="man-subtitle-3 mb-12px">Notice & Assignment</h4>
                            <p class="man-subtitle-2 man-subtitle-2-black">We’ve made it easier than ever to create, manage, and grow a profitable coaching business that client results.</p>
                        </div>
                    </li>
                </ul>
...
<section>
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h1 class="es-title-1 text-center mb-4">Why Use <span class="text-red-gradient4">Academy LMS</span></h1>
            </div>
        </div>
        <div class="row justify-content-center mb-100px">
            <div class="col-md-4 col-sm-6">
                <div class="wh-simple-hover-card max-sm-w-450px mx-auto">
                    ...
                    <p class="man-subtitle-2 man-subtitle-2-black pt-4 text-center">Properly organize and truck all tasks and projects.</p>
                </div>
            </div>
            <div class="col-md-4 col-sm-6">
                <div class="wh-simple-hover-card max-sm-w-450px mx-auto">
...
<section>
    <div class="container">
        <div class="row mb-32px justify-content-center">
            <div class="col-lg-8">
                <h1 class="es-title-1 text-center">Everything you wish for in</h1>
                <h1 class="es-title-1 text-center mb-4 text-red-gradient5">a Academy LMS</h1>
                <p class="man-subtitle-2 man-subtitle-2-black text-center max-w-750px mx-auto">We’ve made it easier than ever to create, manage, and grow a profitable coaching business that achieves transformational client results  Lorem Ipsum available.</p>
            </div>
        </div>
        <div class="row mb-100px">
            <div class="col-lg-4 col-md-6 col-sm-6">
                ...
                <h4 class="man-title-4 text-center">Uplifts Your Business</h4>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6">
                ...
                <h4 class="man-title-4 text-center">Safe & Secure System</h4>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6">
                ...
                <h4 class="man-title-4 text-center">Easy to Use</h4>
            </div>
        </div>
    </div>
</section>
...
<section>
    <div class="container">
        <div class="row mb-32px justify-content-center">
            <div class="col-lg-8">
                <h1 class="es-title-1 text-center mb-20px">Frequently Asked Questions</h1>
                <p class="man-subtitle-2 man-subtitle-2-black text-center max-w-575px mx-auto">Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised</p>
            </div>
        </div>
        <!-- Faqs Items -->
        <div class="row justify-content-center mb-100px">
...
<section>
    <div class="container">
        <div class="row mb-32px justify-content-center">
            <div class="col-lg-8">
                <h1 class="es-title-1 text-center mb-20px">Pricing Plans</h1>
                <p class="man-subtitle-2 man-subtitle-2-black text-center max-w-575px mx-auto">Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised</p>
            </div>
        </div>
        <div class="row mb-32px">
            <div class="col-12">
                <ul class="nav nav-pills btnradio-nav-pills mx-auto" id="pills-tab2" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="pills-monthly-tab" data-bs-toggle="pill" data-bs-target="#pills-monthly" type="button" role="tab" aria-controls="pills-monthly" aria-selected="true">Monthly Subscription</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-yearly-tab" data-bs-toggle="pill" data-bs-target="#pills-yearly" type="button" role="tab" aria-controls="pills-yearly" aria-selected="false">Yearly Subscription</button>
                    </li>
                </ul>          
            </div>
        </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-4 col-md-6">
                                <div class="ci-pricing-card max-md-w-450px mx-auto">
                                    <p class="pricing-package-name mb-2">Pro</p>
                                    <p class="man-subtitle-5 mb-12px">Lorem Ipsum available, but the majority have suffered alteration some injected humour believable to use a passage.</p>
                                    <div class="d-flex align-items-end gap-1 flex-wrap mb-3">
                                        <h1 class="es-title-2">$120.00</h1>
                                        <h5 class="man-title-4">/month</h5>
                                    </div>
                                    <ul class="mb-4">
                                        <li class="ci-check-listitem">Task Management</li>
                                        <li class="ci-check-listitem">Project Planning</li>
                                        <li class="ci-check-listitem">Team Collaboration</li>
                                        <li class="ci-check-listitem">Notifications and Reminders</li>
                                        <li class="ci-check-listitem">What you get</li>
                                    </ul>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="ci-pricing-card max-md-w-450px mx-auto">
                                    <p class="pricing-package-name mb-2">Pro Plus</p>
                                    <p class="man-subtitle-5 mb-12px">Lorem Ipsum available, but the majority have suffered alteration some injected humour believable to use a passage.</p>
                                    <div class="d-flex align-items-end gap-1 flex-wrap mb-3">
                                        <h1 class="es-title-2">$1200.00</h1>
                                        <h5 class="man-title-4">/month</h5>
                                    </div>
                                    <ul class="mb-4">
                                        <li class="ci-check-listitem">Task Management</li>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="ci-pricing-card active max-md-w-450px mx-auto">
                                    <p class="pricing-package-name bg-white mb-2">Custom</p>
                                    <p class="man-subtitle-5 mb-12px text-white">Lorem Ipsum available, but the majority have suffered alteration some injected humour believable to use a passage.</p>
                                    <div class="mb-3">
                                    <h1 class="es-title-2 text-white">Let’s Talk</h1>
                                    </div>
                                    <ul class="mb-4">
                                        <li class="ci-check-listitem text-white">Task Management</li>
                                        <li class="ci-check-listitem text-white">Project Planning</li>
                                        <li class="ci-check-listitem text-white">Team Collaboration</li>
                                        <li class="ci-check-listitem text-white">Notifications and Reminders</li>
                                        <li class="ci-check-listitem text-white">What you get</li>
                                    </ul>
                                    <a href="#" class="btn btn-outline-primary-ci1 text-center w-100 bg-white">Book a Call</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row align-items-center mb-100px">
            <div class="col-md-6">
                <div class="md-mt-40px">
                    <h1 class="es-title-1 es-title-1-black mb-20px">Spending too much time on LMS? We can fix that...</h1>
                    <p class="man-subtitle-2 man-subtitle-2-black mb-32px">We’ve made it easier than ever to create, manage, and grow a profitable coaching business that client results.</p>
...
<section>
    <div class="container">
        <div class="row mb-32px justify-content-center">
            <div class="col-lg-8">
                <h1 class="es-title-1 text-center mb-20px">Appealing Course Features</h1>
                <p class="man-subtitle-2 man-subtitle-2-black text-center max-w-575px mx-auto">Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised</p>
            </div>
        </div>
        <div class="row">
                ...
                <ul class="nav nav-pills texttab-nav-pills row justify-content-center" id="pills-tab" role="tablist">
                    <li class="nav-item col-lg-4 col-md-6" role="presentation">
                        <button class="nav-link active max-w-306px mx-auto h-100" id="pills-media1-tab" data-bs-toggle="pill" data-bs-target="#pills-media1" type="button" role="tab" aria-controls="pills-media1" aria-selected="true">
                            <h5 class="man-title-4 mb-20px">Uplifts Your Business</h5>
                            <p class="man-subtitle-2 man-subtitle-2-black">We’ve made it easier than ever to create, manage, and grow a profitable coaching business that achieves transformational client results. Lorem Ipsum available.</p>
                        </button>
                    </li>
                    <li class="nav-item col-lg-4 col-md-6" role="presentation">
                        <button class="nav-link max-w-306px mx-auto h-100" id="pills-media2-tab" data-bs-toggle="pill" data-bs-target="#pills-media2" type="button" role="tab" aria-controls="pills-media2" aria-selected="false">
                            <h5 class="man-title-4 mb-20px">Safe & Secure System</h5>
                            <p class="man-subtitle-2 man-subtitle-2-black">We’ve made it easier than ever to create, manage, and grow a profitable coaching business that achieves transformational client results. Lorem Ipsum available.</p>
                        </button>
                    </li>
                    <li class="nav-item col-lg-4 col-md-6" role="presentation">
                        <button class="nav-link max-w-306px mx-auto h-100" id="pills-media3-tab" data-bs-toggle="pill" data-bs-target="#pills-media3" type="button" role="tab" aria-controls="pills-media3" aria-selected="false">
                            <h5 class="man-title-4 mb-20px">Easy to Use</h5>
                            <p class="man-subtitle-2 man-subtitle-2-black">We’ve made it easier than ever to create, manage, and grow a profitable coaching business that achieves transformational client results. Lorem Ipsum available.</p>
                        </button>
                    </li>
                </ul>          
