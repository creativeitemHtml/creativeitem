    ...
    <div class="row justify-content-between w-100">
        <div class="col-lg-9 col-12">
            <div class="d-flex align-items-center">
                ...
                @if($feature->name == 'Pro')
                    <span class="model-title-value mb-0"> Included Basic Packages</span>
                @elseif($feature->name == 'Business')
                    <span class="model-title-value mb-0"> Included Professional & Business Packages</span>
                @else
        ...
        <div class="col-lg-3 col-12">
            <div class="bar-controls d-flex text-sm-center align-items-center justify-content-end p-0 ps-4">
                ...
                <button type="button" class="ciBtn ciBtn-primary ms-2" onclick="buyNowModal('{{ route('service_buy_now', ['service_id' => $feature->id]) }}')" data-bs-dismiss="modal" aria-label="Close">Buy Now</button>
