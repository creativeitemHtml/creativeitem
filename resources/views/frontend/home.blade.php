        ...
        <div class="row align-items-center mb-100px">
            <div class="col-md-6">
                <div class="ci-banner-details1">
                    ...
                    <h1 class="mb-20px es-title-1 ci-top-banner-title1"><span class="ci-text-secondary">{{ get_phrase('Explore Premium UI Elements') }}</span> <span class="ci-title-gradient">{{ get_phrase('To Leve') }}<span class="ci-title-gradient-italic">{{ get_phrase('l') }}</span> {{ get_phrase('U') }}<span class="ci-title-gradient-italic">{{ get_phrase('p') }}</span></span> {{ get_phrase('Your Projects') }}</h1>
        ...
        <div class="row align-items-center mb-100px">
            <div class="col-md-6">
                <div class="ci-product-short-details">
                    ...
                    <p class="man-subtitle-2 mb-40px">{{ get_phrase('Atlas brings all types of businesses listed together in one place. Agents can subscribe to your platform and list their businesses according to a diverse range of categories. Customers can explore and connect with businesses directly across our intuitive platform.') }}</p>
                    <div class="d-flex align-items-center g-30px flex-wrap">
