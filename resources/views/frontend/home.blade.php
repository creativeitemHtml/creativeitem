...
@section('content')
            ...
            <div class="row align-items-center mb-100px">
                <div class="col-md-6">
                    <div class="ci-banner-details1">
                        ...
                        <h1 class="mb-20px es-title-1 ci-top-banner-title1"><span class="ci-text-secondary">{{ get_phrase('Explore Premium UI Elements') }}</span> <span class="ci-title-gradient">{{ get_phrase('To Leve') }}<span class="ci-title-gradient-italic">{{ get_phrase('l') }}</span>
    ...
    <section class="ci-counter-section mb-100px">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="es-title-1 ci-counter-section-title text-center">{{ get_phrase('Trusted by') }} <span class="text-red-gradient1">{{ get_phrase('27,000') }}</span> {{ get_phrase('Individuals') }} <br> {{ get_phrase('Agencies &Enterprises all over the world') }}</h1>
                </div>
            </div>
            ...
            <div class="row align-items-center mb-100px">
                <div class="col-md-6">
                    <div class="ci-product-short-details">
                        ...
                        <p class="man-subtitle-2 mb-40px">{{ get_phrase('Create, Manage, and sell your courses in one place. Academy LMS allows you to create courses and earn money by selling them to your students. Your students can browse through the options and select the best course for them.') }}
                        </p>
                        <div class="d-flex align-items-center g-30px flex-wrap">
            ...
            <div class="row align-items-center mb-100px">
                <div class="col-md-6">
                    <div class="ci-product-short-details">
                        ...
                        <h2 class="es-title-3 mb-20px">{{ get_phrase('Upgrade Your School’s Routine Management Operations With ') }} <span class="text-red-gradient2">{{ get_phrase('Ekattor 8') }}</span></h2>
                        <p class="man-subtitle-2 mb-40px">{{ get_phrase("Keep track of your school's activity with Ekattor 8 ERP. Ekattor 8 is designed to assist your schools in administering the responsibilities on a day-to-day basis by reducing the pressure of managing a large amount of data.") }}
                        </p>
                        <div class="d-flex align-items-center g-30px flex-wrap">
            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="best-products">
                        ...
                        <p class="info">{{ get_phrase('We work on products that matter &amp; make the product keeping in mind customers needs. What you actually want, whats going to reduce your workload, and make your life easier is our first priority') }}.</p>
                    </div>
                </div>
            </div>
            <!-- Items -->
            ...
            <div class="row align-items-center">
                <div class="col-lg-4">
                    <div class="me-lg-4 pt-lg-0 pt-5">
                        ...
                        <p class="man-subtitle-2 mb-40px">{{ get_phrase('Our clients keep coming back for more of our products, and choose our unmatched service and support for their ultimate success.') }}</p>
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="ci-testimonial-card mb-30px">
                                                <p class="man-subtitle-2 mb-32px">{{ get_phrase('The functionality and user experience of Creativeitem\'s products are top-notch. It\'s clear that a lot of thought and effort went into their design and implementation.') }}</p>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="ci-testimonial-card mb-30px">
                                                <p class="man-subtitle-2 mb-32px">{{ get_phrase("I\'ve been using Creativeitem\'s products for over a year now and couldn't be happier. The regular updates and new features keep getting better and better.") }}</p>
                                                <div class="d-flex align-items-center gap-2 justify-content-between">
                                                    <div class="d-flex gap-2 align-items-center">
                                                        <div class="sm-image-wrap">
                            ...
                            <div class="col-md-6">
                                <div class="swiper swiper-vertical">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="ci-testimonial-card mb-30px">
                                                <h4 class="man-title-5 mb-1 text-break">John Doe{{ get_phrase('The LMS software is comprehensive and easy to use, making our training programs more efficient.') }}</h4>
