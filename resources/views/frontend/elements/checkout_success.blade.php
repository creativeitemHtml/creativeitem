    ...
    <div class="container">
        <div class="breadcrumb-two-content">
            <div class="content">
                ...
                <p class="info">
                Element subscription checkout success
                </p>
            </div>
        ...
        <div class="checout-success-wrap">
            ...
            <div class="checkout-success">
                ...
                <div class="checout-btns d-flex flex-wrap justify-content-center g-20">
                    <a href="{{ route('customer.subscription_details') }}" class="btn-1">Review Order</a>
                    <a href="{{ route('elements') }}" class="btn-2">Start Download</a>
                </div>
            </div>
        </div>
    </div>
