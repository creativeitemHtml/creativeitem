                    ...
                    <div class="table-content-wrap">
                        ...
                        <div class="table-of-contents">
                            <div class="table-content-title-close d-flex justify-content-between align-items-center">
                                <h3 class="table-content-title">Table of Contents</h3>
                                <div class="table-content-close">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M9.99915 11.0625L6.58248 14.4792C6.42971 14.6319 6.2561 14.7049 6.06165 14.6979C5.86721 14.691 5.6936 14.6111 5.54082 14.4583C5.38804 14.3056 5.31165 14.1285 5.31165 13.9271C5.31165 13.7257 5.38804 13.5486 5.54082 13.3958L8.93665 10L5.51998 6.58334C5.36721 6.43056 5.29429 6.25348 5.30123 6.05209C5.30818 5.8507 5.38804 5.67362 5.54082 5.52084C5.6936 5.36806 5.87068 5.29167 6.07207 5.29167C6.27346 5.29167 6.45054 5.36806 6.60332 5.52084L9.99915 8.93751L13.4158 5.52084C13.5686 5.36806 13.7457 5.29167 13.9471 5.29167C14.1485 5.29167 14.3255 5.36806 14.4783 5.52084C14.6311 5.67362 14.7075 5.8507 14.7075 6.05209C14.7075 6.25348 14.6311 6.43056 14.4783 6.58334L11.0617 10L14.4783 13.4167C14.6311 13.5694 14.7075 13.7431 14.7075 13.9375C14.7075 14.1319 14.6311 14.3056 14.4783 14.4583C14.3255 14.6111 14.1485 14.6875 13.9471 14.6875C13.7457 14.6875 13.5686 14.6111 13.4158 14.4583L9.99915 11.0625Z" fill="#212534"/>
                                    </svg>                        
                                </div>
                            </div>
        ...
        <div class="row pb-44 justify-content-center">
            <div class="col-md-12">
                <div class="featured-title">
                    <h2 class="text-24">Related Topic</h2>
                </div>
            </div>
            ...
            @endforeach
            <div class="col-md-12">
                <div class="blog-pagination-dots d-flex align-items-center justify-content-center">
                    <span></span>
                    <span></span>
