<div class="admin_main_right p-30 bd-r-5 mb-60">
    <div class="title-btn-menu-wrap d-flex justify-content-between align-items-center flex-wrap g-10 pb-30">
        ...
        <a href="#" class="new-project-btn new-project-btn-desktop">{{ get_phrase('Preview') }}</a>
        <a href="#" class="new-project-btn new-project-btn-desktop">{{ get_phrase('Back to topics') }}</a>
