            ...
            <tbody>
                                ...
                                <div class="feature-item" style="margin-top:30px; ">
                                     ...
                                     <div style="display: flex; justify-content: space-between; align-items: center;">
                                         <div>
                                            ...
                                            <p style="color: #0C141D; font-size: 16px;">Purchase ID: 2024-{{ $payment->id }}</p>
                                         </div>
                                     </div>
                                </div>
                           </div>
                ...
                <tr style="text-align: center;">
                    <td>
                        ...
                        <p style="font-size: 15px; color: #7B7F84; margin: 0; margin-top: 6px;">{{ Ucwords($payment->payment_method) }}</p>
                    </td>
                </tr>
                <tr>
