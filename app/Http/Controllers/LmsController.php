...
class LmsController extends Controller
{
    ...
    function create_db($company_data) 
    {
    ...
    function create_blank_sql($db_name, $db_user, $db_pass, $db_host, $company_data){
    ...
    function insert_db_config($db_name, $db_user, $db_pass, $db_host, $company_data) {
    ...
    function insert_db_config_to_main_db($db_name, $company_data) {
